...
public final class AutoScrollViewPager extends ViewPager {
	...
	private J2WCustomDurationScroller	scroller					= null;

	public static final int			SCROLL_WHAT					= 0;

	private boolean					infinitePagesEnabled		= true;

	J2WInfinitePagerAdapter			infinitePagerAdapter;

	@Override public void setAdapter(PagerAdapter adapter) {
		infinitePagerAdapter = new J2WInfinitePagerAdapter((J2WInfiniteStatePagerAdapter) adapter);
        infinitePagerAdapter.enableInfinitePages(infinitePagesEnabled);
		super.setAdapter(infinitePagerAdapter);

		((J2WInfiniteStatePagerAdapter) adapter).autoScrollViewPager.setOnPageChangeListener(infinitePagerAdapter);
	...
	public void enableInfinitePages(boolean enable) {
		...
		if (getAdapter() instanceof J2WInfinitePagerAdapter) {
			J2WInfinitePagerAdapter infAdapter = (J2WInfinitePagerAdapter) getAdapter();
	...
	private void setViewPagerScroller() {
		try {
			...
			scroller = new J2WCustomDurationScroller(getContext(), (Interpolator) interpolatorField.get(null));
