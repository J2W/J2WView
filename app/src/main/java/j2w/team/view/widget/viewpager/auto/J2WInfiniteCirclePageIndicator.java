...
import j2w.team.view.widget.viewpager.PageIndicator;


/**
 * @创建人 sky
 * @创建时间 15/7/27 上午10:34
 * @类描述 ViewPager 指示器 圆形
 */
public class J2WInfiniteCirclePageIndicator extends View implements PageIndicator {
	...
	public J2WInfiniteCirclePageIndicator(Context context) {
		this(context, null);
	}

	public J2WInfiniteCirclePageIndicator(Context context, AttributeSet attrs) {
		this(context, attrs, R.attr.vpiCirclePageIndicatorStyle);
	}

	public J2WInfiniteCirclePageIndicator(Context context, AttributeSet attrs, int defStyle) {
	...
	@Override protected void onDraw(Canvas canvas) {
		...
		final int count = ((J2WInfinitePagerAdapter) mViewPager.getAdapter()).getRealCount();
		if (count == 0) {
			return;
		}
	...
	@Override public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
		mCurrentPage = ((J2WInfinitePagerAdapter) mViewPager.getAdapter()).getVirtualPosition(position);
